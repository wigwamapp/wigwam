...
function validateTypedMessageSchema(
  ...
  return validate(typedMessage) as any;
}
...
const encodeDataExamples: Record<string, any> = {
...
const encodeDataErrorExamples: Record<string, any> = {
  address: [
    {
...
const allExampleTypes = [
  ...new Set(
    Object.keys(encodeDataExamples).concat(Object.keys(encodeDataErrorExamples))
  ),
];
...
const signTypedDataV1Examples: Record<string, any> = {
  // dynamic types supported by EIP-712:
  bytes: [10, "10", "0x10", Buffer.from("10", "utf8")],
  string: [
    "Hello!",
...
const signTypedDataV1ErrorExamples: Record<string, any> = {
  string: [
    {
