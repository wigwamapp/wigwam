    ...
    <Box display="flex" justifyContent={'space-between'} flex={1} mt={2}>
        ...
        <Box display="flex" alignItems="center" mr={dense ? 0 : 2}>
          <IconTypography>
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="19" viewBox="0 0 18 19" fill="none">
              <g clip-path="url(#clip0_1562_28916)">
      ...
      >
        <Box display="flex" alignItems="center" mr={dense ? 0 : 2}>
          <IconTypography>
          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="19" viewBox="0 0 18 19" fill="none">
            <g clip-path="url(#clip0_1562_28928)">
      ...
      >
        <Box display="flex" alignItems="center">
          <IconTypography>
          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="19" viewBox="0 0 18 19" fill="none">
            <g clip-path="url(#clip0_1562_28933)">
